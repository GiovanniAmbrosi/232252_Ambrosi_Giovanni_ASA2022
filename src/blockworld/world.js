...
world.TurnOnLight = function ({x, room} = args) {
    return new TurnOnLight(world, new Goal({x, room}) ).checkPreconditionAndApplyEffect()
    .catch(err=>{throw new Error('world.TurnOnLight failed')})
}
